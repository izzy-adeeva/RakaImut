...
from helper_func import decode, get_messages, subsall, subsch, subsgc, substai, subslg
...
@Bot.on_message(filters.command("start") & filters.private & subsall & subsch & subsgc & substai & subslg)
